...
namespace EnumsBenchmark.Models
{
    ...
    public abstract class Enumeration<TEnumeration> : Enumeration where TEnumeration : Enumeration
    {
        ...
        public static IReadOnlyList<TEnumeration> GetValues()
        {
            return Values;
        }
        ...
        {
            return typeof(TEnumeration).GetFields(BindingFlags.Public | BindingFlags.Static)
        ...
        public static TEnumeration Parse(string value, bool ignoreCase)
        {
            return ignoreCase
        ...
        public static bool TryParse(string value, out TEnumeration enumeration) => ValuesDictionary.TryGetValue(value, out enumeration);

        public static bool TryParse(string value, bool ignoreCase, out TEnumeration enumeration)
        {
            if (!ignoreCase) return ValuesDictionary.TryGetValue(value, out enumeration);
