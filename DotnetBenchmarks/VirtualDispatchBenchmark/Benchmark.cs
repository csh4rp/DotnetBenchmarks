...
namespace VirtualDispatchBenchmark
{
    public class Benchmark
    {
        ...
        public void RunStaticCall()
        {
            ...
            {
                _value = StaticCalculator.Add(X, Y);
            }
        }
        ...
        public void RunSealedChildClassCall()
        {
            for (var i = 0; i < NumberOfIterations; i++)
            {
                _value = SealedCalculatorFromBaseClass.Add(X, Y);
            }
        }
        ...
        public void RunSubClassCall()
        {
            for (var i = 0; i < NumberOfIterations; i++)
            {
                _value = CalculatorFromBaseClass.Add(X, Y);
            }
        }
        ...
        public void RunInterface()
        {
            for (var i = 0; i < NumberOfIterations; i++)
            {
                _value = InterfaceCalculator.Add(X, Y);
            }
        }
    }
}